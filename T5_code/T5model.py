...
# 定义保存结果的文件路径
csv_file_path = '../T5_datasets/submission.csv'
...
#重写文件：改写为提交文件格式
import csv
with open('../T5_datasets/submission.csv', 'r', newline='', encoding='utf-8') as f1:
    with open('T5_datasets/submission_format.csv', 'w', newline='', encoding='utf-8') as f2:
